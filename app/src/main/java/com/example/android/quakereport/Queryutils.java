...
public final class Queryutils {
    ...
    /**
     * Return a list of {@link Earthquack} objects that has been built up from
     * parsing a JSON response.
     */
  /*  public static ArrayList<Earthquack> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<Earthquack> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONArray featuresarray = jsonObjectroot.getJSONArray("features");
            ...
            for (int i=0 ; i<featuresarray.length() ; i++) {
                    ...
                    Earthquack earthquack=new Earthquack(magnitude,location,date,url);
                    earthquakes.add(earthquack);
...
/*    Modify the extractEarthquakes() method that handles JSON parsing. I renamed it to extractFeatureFromJson() and to take a JSON response String as input. Instead of hardcoding the extractFeatureFromJson() method to only be able to parse the hardcoded SAMPLE_JSON_RESPONSE String, this method becomes more reusable in different contexts if we accept a String input.
    ...
    private static List<Earthquack> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Earthquack earthquake = new Earthquack(magnitude, location, time, url);
    ...
    /**
     * Query the USGS dataset and return a list of {@link Earthquack} objects.
     */
    public static List<Earthquack> fetchEarthquakeData(String requestUrl) {
        ...
        List<Earthquack> earthquakes = extractFeatureFromJson(jsonResponse);
